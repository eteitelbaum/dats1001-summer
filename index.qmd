...
|  | `r advdate(wed,3)` | Dealing with outliers | [📖](https://openintro-ims.netlify.app/model-slr#sec-outliers-in-regression "IMS, chap. 7.3") | [📺](https://youtu.be/4pgaVtVBVjk?si=Wq93tjXuVj42s4Yf "Principles of Model Selection") | [📒](modules/module-4.3.qmd "Dealing with Outliers") | 📘 | `r advdate(wed,3)` |
...
|  | `r advdate(fri,3)` | Model selection | [📖](https://openintro-ims.netlify.app/model-mlr#sec-model-selection "IMS, chap. 8.4") | 📺 | [📒](http://localhost:3023/modules/module-4.5.html "Model Selection") |  |  |
