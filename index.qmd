...
|  | `r advdate(sat,2)` | Differences between two groups | [📖](https://openintro-ims.netlify.app/foundations-randomization "IMS, chap. 11") | [📺](https://www.youtube.com/watch?v=2pHhjx9hyM4 "Using Randomization to Analyze Gender Discrimination") | 📒 | 📘 [🧮](assignments/coding-assignment-3.qmd "Coding assingment 3") | `r advdate(sun,3)` |
