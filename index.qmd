...
|  | `r advdate(sat,1)` | Cleaning data | [📖](https://link.springer.com/article/10.1057/palgrave.ap.5500151 "Norris") | [📺](https://youtu.be/ZwJsSjJRuMU "Reading Data into R with read_csv()") [📺](https://youtu.be/u4AXi8A1Bqo?si=OVnjerTuxm6bYIKb "Reshaping Data in R") [📺](https://youtu.be/xa0tYCfHHTI?si=1YII-L90IY05UZ70 "Cleaning Data in R") | [📒](modules/module-2.6.qmd "Cleaning Data") | 📘 [🧮](assignments/coding-assignment-2.qmd "Coding assingment 2") | `r advdate(sun,1)` |
