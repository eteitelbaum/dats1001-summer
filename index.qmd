...
|  | `r advdate(sat,3)` | Checking model assumptions | [📖](https://openintro-ims.netlify.app/explore-numerical#sec-transforming-data "IMS, chap. 5.7") [📖](https://openintro-ims.netlify.app/inf-model-slr#sec-tech-cond-linmod "IMS, chap. 24.6") | [📺](video%20https://youtu.be/iMdtTCX2Q70?si=5qhftnJZ0jYRhmdB "Checking Model Assumptions with Residual Plots") | [📒](modules/module-4.6.qmd "Checking Model Assumptions") | 📘 [🧮](assignments/coding-assignment4.qmd "Coding Assignment 4") | `r advdate(sun,4)` |
...
|  | `r advdate(sat,4)` | How Would We Model This Today? |  |  | [📒](modules/module-5.6.qmd "How Would We Model This Today?") | 📘 [🧮](assignments/coding-assignment5.qmd "Coding Assignment 5") | `r advdate(sun,5)` |
