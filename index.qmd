...
|  | `r advdate(thur,4)` | Multiple predictors & interactions | [📖](https://openintro-ims.netlify.app/model-logistic#logistic-model-with-many-variables "IMS, chap. 9.3 and 9.4") |  | 📒 |  |  |
