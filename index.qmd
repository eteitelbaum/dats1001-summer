...
|  | `r advdate(thur,3)` | Multiple linear regression | [📖](https://openintro-ims.netlify.app/model-mlr "IMS, chap. 8.1 and 8.2") | [📺](https://youtu.be/jXg0vU0y1ak?si=rhQ9uWhuhVqnI-Ox "Linear Regression with Multiple Variables") | 📒 |  |  |
