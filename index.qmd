...
| 4 | `r advdate(mon,3)` | Fitting a line to data | [📖](https://openintro-ims.netlify.app/model-slr#sec-fit-line-res-cor "IMS, chap. 7.1") | [📺](https://youtu.be/dLc-lfEEYss?si=-Zelb-HBAP-MPvnF "Linear Regression with One Variable, Part 1") [📺](https://youtu.be/KWULpBYzIYk?si=z_-wmdYlyrdpN4ys "Linear Regression with One Variable, Part 2") | 📒 |  |  |
