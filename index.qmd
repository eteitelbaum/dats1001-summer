...
|  | `r advdate(thur,2)` | Sampling and uncertainty | [📖](https://openintro-ims.netlify.app/foundations-bootstrapping "IMS, chap. 12") | [📺](https://youtu.be/Xz0x-8-cgaQ?si=v_YCi-dU5YBdcb99 "Bootstrapping Main Ideas") | [📒](modules/module-3.4.qmd "Sampling and uncertainty") |  |  |
|  | `r advdate(fri,2)` | Single proportion tests | [📖](https://openintro-ims.netlify.app/inference-one-prop "IMS, chap. 16") | 📺 | 📒 |  |  |
|  | `r advdate(sat,2)` | Relationship between two variables | [📖](https://openintro-ims.netlify.app/foundations-randomization "IMS, chap. 11") | 📺 | 📒 | 📘 [🧮](assignments/coding-assignment-3.qmd "Coding assingment 3") | `r advdate(sun,3)` |
