...
| 4 | `r advdate(mon,3)` | Fitting a line to data | [📖](https://openintro-ims.netlify.app/model-slr#sec-fit-line-res-cor "IMS, chap. 7.1") | [📺](https://youtu.be/dLc-lfEEYss?si=-Zelb-HBAP-MPvnF "Linear Regression with One Variable, Part 1") [📺](https://youtu.be/KWULpBYzIYk?si=z_-wmdYlyrdpN4ys "Linear Regression with One Variable, Part 2") | [📒](modules/module-4.1.qmd "Fitting a Line to Data") |  |  |
|  | `r advdate(tues,3)` | Least squares regression | [📖](openintro-ims.netlify.app/model-slr#sec-least-squares-regression "IMS, chap. 7.2") | [📺](https://youtu.be/CFN5zHzEuGY?si=uX_MFAbbSIzXMYQJ "Cost Function") [📺](https://youtu.be/peNRqkfukYY?si=UtakmQc9KLaQj7UH "Cost Function Intuition") | [📒](modules/module-4.2 "Least Squares Regression") |  |  |
|  | `r advdate(wed,3)` | Dealing with outliers | [📖](https://openintro-ims.netlify.app/model-slr#sec-outliers-in-regression "IMS, chap. 7.3") | [📺](https://youtu.be/OYwq0MlY11g?si=YV1JVOTqTLUJgk0U "What Should You Do With Outliers?") | [📒](modules/module-4.3.qmd "Dealing with Outliers") | 📘 | `r advdate(wed,3)` |
|  | `r advdate(thur,3)` | Multiple linear regression | [📖](https://openintro-ims.netlify.app/model-mlr "IMS, chap. 8.1 and 8.2") | [📺](https://youtu.be/jXg0vU0y1ak?si=rhQ9uWhuhVqnI-Ox "Linear Regression with Multiple Variables") | [📒](modules/module-4.4.qmd "Multiple Linear Regression") |  |  |
|  | `r advdate(fri,3)` | Model selection | [📖](https://openintro-ims.netlify.app/model-mlr#sec-model-selection "IMS, chap. 8.4") | [📺](https://youtu.be/4pgaVtVBVjk?si=Wq93tjXuVj42s4Yf "Principles of Model Selection") | [📒](modules/module-4.5.qmd "Model Selection") |  |  |
|  | `r advdate(sat,3)` | Checking model assumptions | [📖](https://openintro-ims.netlify.app/explore-numerical#sec-transforming-data "IMS, chap. 5.7") [📖](https://openintro-ims.netlify.app/inf-model-slr#sec-tech-cond-linmod "IMS, chap. 24.6") | [📺](video%20https://youtu.be/iMdtTCX2Q70?si=5qhftnJZ0jYRhmdB "Checking Model Assumptions with Residual Plots") | [📒](modules/module-4.6.qmd "Checking Model Assumptions") | 📘 [🧮](assignments/coding-assignment-4.qmd "Coding Assignment 4") | `r advdate(sun,4)` |
| 5 | `r advdate(mon,4)` | Why logistic regression? |  | [📺](https://youtu.be/p-ltr1C7u2o?si=TLb3y75pSaJ067ue "Classification: Motivation") | [📒](modules/module-5.1.qmd "Why Logistic Regression?") |  |  |
|  | `r advdate(tues,4)` | The logistic regression model | [📖](https://openintro-ims.netlify.app/model-logistic "IMS, chap. 9.1 and 9.2") | [📺](https://youtu.be/xuTiAW0OR40?si=sUoIr5pzHwHEpazO) | [📒](modules/module-5.2.qmd "The Logistic Regression Model") |  |  |
|  | `r advdate(wed,4)` | Interpreting results |  | [📺](https://youtu.be/oIR8YOSXudM?si=aEALe2ifW71lsJJG "Odds Ratios in Logistic Regression") | [📒](modules/module-5.3.qmd "Interpreting Results") | 📘 | `r advdate(wed,4)` |
|  | `r advdate(thur,4)` | Multiple predictors & interactions | [📖](https://openintro-ims.netlify.app/model-logistic#logistic-model-with-many-variables "IMS, chap. 9.3 and 9.4") | [📺](https://youtu.be/eb5lGVHHlY0?si=BCQJhZHezE9ihLg3 "Effect Multipliers in Logistic Regression") | [📒](modules/module-5.4.qmd "Multiple Predictors & Interactions") |  |  |
|  | `r advdate(fri,4)` | Visualizing and communicating results |  | [📺](https://youtu.be/My6_X6x5TZw "Display Multiple Models with Model Summary") [📺](https://youtu.be/gif_wkqyub8 "Coefficient Plots for Single Models") | [📒](modules/module-5.5 "Visualizing and Communicating Results") |  |  |
|  | `r advdate(sat,4)` | How Would We Model This Today? |  |  | [📒](modules/module-5.6.qmd "How Would We Model This Today?") | 📘 [🧮](assignments/coding-assignment-5.qmd "Coding Assignment 5") | `r advdate(sun,5)` |
| 6 | `r advdate(mon,5)` | Final Project |  |  |  |  |  |
|  | `r advdate(tues,5)` | Final Project |  |  |  | [✍️](project/project-assignment-1.qmd "Project assignment 1") | `r advdate(tues,5)` |
|  | `r advdate(wed,5)` | Final Project |  |  |  |  |  |
|  | `r advdate(thur,5)` | Final Project |  |  |  | [✍️](project/project-assignment-2.qmd "Project assignment 2") | `r advdate(thur,5)` |
|  | `r advdate(fri,5)` | Final project |  |  |  |  |  |
|  | `r advdate(sat,5)` | Final project |  |  | [📒](moduels/reveal-how-to.qmd "How to RevealJS") | [✍️](project/project-assignment-3.qmd "Project assignment 3") | `r advdate(sat,5)` |
:::
