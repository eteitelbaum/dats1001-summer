...
|  | `r advdate(tues,1)` | Transforming data | [📖](https://r4ds.hadley.nz/data-transform "rd4s, chap. 3.1-3.4") | [📺](https://youtu.be/ScQD47eJeAE?si=Rc6epCTKhQVtkCjS "Transforming data w/ dplyr verbs") | 📒 |  |  |
|  | `r advdate(wed,1)` | Summarizing data | [📖](https://r4ds.hadley.nz/data-transform#groups "r4ds, chap. 3.5") | [📺](https://youtu.be/mgBwVzMV-v8?si=4KP-qyDyssI92iFe "Grouping and summarizing data") | 📒 | 📘 | `r advdate(wed,1)` |
