...
|  | `r advdate(tues,3)` | Least squares regression | [📖](openintro-ims.netlify.app/model-slr#sec-least-squares-regression "IMS, chap. 7.2") | [📺](https://youtu.be/CFN5zHzEuGY?si=uX_MFAbbSIzXMYQJ "Cost Function") [📺](https://youtu.be/peNRqkfukYY?si=UtakmQc9KLaQj7UH "Cost Function Intuition") | [📒](modules/module-4.2.qmd "Least Squares Regression") |  |  |
|  | `r advdate(wed,3)` | Dealing with outliers | [📖](https://openintro-ims.netlify.app/model-slr#sec-outliers-in-regression "IMS, chap. 7.3") |  | 📒 | 📘 | `r advdate(wed,3)` |
