...
|  | `r advdate(fri,1)` | Tidying data | [📖](https://r4ds.hadley.nz/data-tidy "r4ds, chap. 5.3-5.5") | [📺](https://youtu.be/u4AXi8A1Bqo?si=OVnjerTuxm6bYIKb "Reshaping Data in R") | [📒](modules/module-2.5.qmd "Tidying Data") |  |  |
|  | `r advdate(sat,1)` | Cleaning data | [📖](https://link.springer.com/article/10.1057/palgrave.ap.5500151 "Norris") | [📺](https://youtu.be/xa0tYCfHHTI?si=1YII-L90IY05UZ70 "Tidying data") | 📒 | 📘 [🧮](assignments/coding-assignment-2.qmd "Coding assingment 2") | `r advdate(sun,1)` |
