...
|  | `r advdate(tues,4)` | The logistic regression model | [📖](https://openintro-ims.netlify.app/model-logistic "IMS, chap. 9") | [📺](https://youtu.be/xuTiAW0OR40?si=sUoIr5pzHwHEpazO) | [📒](modules/module-5.2.qmd "The Logistic Regression Model") |  |  |
|  | `r advdate(wed,4)` | Interpreting results |  | 📺 | 📒 | 📘 | `r advdate(wed,4)` |
|  | `r advdate(thur,4)` | Prediction and overfitting |  |  | 📒 |  |  |
|  | `r advdate(fri,4)` | Model evaluation, feature engineering |  |  | 📒 |  |  |
