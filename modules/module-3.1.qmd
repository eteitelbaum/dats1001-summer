...
We’ll use the `vdemlite` R package to load the 2022 values of this classification along with regional groupings. First, we load the necessary packages and retrieve the data.
